...
const fixtureUrl =
  "https://raw.githubusercontent.com/dmihal/chmlib-ts/master/fixtures/PowerCollections.chm";

/** Ensure the PowerCollections.chm integration fixture exists on disk. */
export async function ensurePowerCollectionsFixture(): Promise<string> {
